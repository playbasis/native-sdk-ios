...
class PBGoodsApi: PBBaseApi {
    ...
    class func goodListWithPlayerId(playerId:String? = nil, tags:String, completionBlock:PBGoodsCompletionBlock, failureBlock:PBFailureErrorBlock) {
    ...
    class func verifyCouponWithGoodId(goodId:String, couponCode:String, completionBlock:PBEmptyCompletionBlock, failureBlock:PBFailureErrorBlock) {
    ...
    class func redeemCouponWithGoodId(goodId:String, couponCode:String, playerId:String, completionBlock:PBEmptyCompletionBlock, failureBlock:PBFailureErrorBlock) {
    ...
    class func getGoodsWithGoodIdAndPlayerId(goodId:String,playerId:String, completionBlock:(goods:PBGoods) -> Void, failureBlock:PBFailureErrorBlock) {
