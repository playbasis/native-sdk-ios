...
open class PBRedeemApi: PBBaseApi {
    ...
    open class func redeemGoodId(_ goodId:String, playerId:String, completionBlock:@escaping PBEmptyCompletionBlock, failureBlock:@escaping PBFailureErrorBlock) {
    ...
    open class func redeemGoodGroupWithGroup(_ group:String, playerId:String, completionBlock:@escaping PBEmptyCompletionBlock, failureBlock:@escaping PBFailureErrorBlock) {
