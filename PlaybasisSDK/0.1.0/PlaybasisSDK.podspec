...
Documentation is also available
  ...
  s.homepage         = 'https://bitbucket.org/smartsoftasia/playbasis-sdk-ios/overview'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Med' => 'med@smartsoftasia.com' }
s.source           = { :git => 'https://medericpetit@bitbucket.org/smartsoftasia/playbasis-sdk-ios.git', :tag => s.version.to_s, :branch => 'master' }
